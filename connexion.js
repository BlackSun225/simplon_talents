...
const comob = document.querySelector("#co span.mob");
const regmob = document.querySelector("#reg span.mob"); 
...
comob.addEventListener("click", () => {
  divco.style.display = "none";
  divreg.style.display = "flex";
});

regmob.addEventListener("click", () => {
